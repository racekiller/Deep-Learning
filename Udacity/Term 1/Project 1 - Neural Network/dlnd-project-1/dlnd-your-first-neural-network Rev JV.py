...
record, target = (train_features.ix[batch].values, train_targets.ix[batch]['cnt'])
...
weights_i = np.random.normal(0.0, hidden_nodes**-0.5, (hidden_nodes, input_nodes))
...
class NeuralNetwork:
    ...
    def train(self, inputs_list, targets_list):
        ...
        hidden_errors = output_errors * final_outputs * (1 - final_outputs)
        
        # hidden layer gradients
        hidden_grad = np.dot(output_errors, self.weights_hidden_to_output) * hidden_outputs * (1 - hidden_outputs)
        
        # TODO: Update the weights
        # update hidden-to-output weights with gradient descent step
        self.weights_hidden_to_output += hidden_outputs * output_errors
        
        # update input-to-hidden weights with gradient descent step
        self.weights_input_to_hidden += hidden_errors * inputs[:,None]
